...
<div class="flex flex-col items-start justify-start p-1 mx-2 aspect-[12/5] my-3 rounded-lg bg-midnight-900/45">
    ...
    <section class="flex space-x-3">
        <a href={url} title="Play" class="hover:text-green-400 hover:drop-shadow-[0_2px_3px_rgba(74,222,128,0.45)] transition-all duration-100 ease-out">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 0 1 0 1.972l-11.54 6.347a1.125 1.125 0 0 1-1.667-.986V5.653Z" />
            </svg>              
        </a>
        <button on:click={() => confirmDelete()} title="Delete" class="hover:text-red-400 hover:drop-shadow-[0_2px_3px_rgba(248,113,113,0.45)] transition-all duration-100 ease-out">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
